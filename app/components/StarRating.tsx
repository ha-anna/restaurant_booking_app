...
export function MaterialSymbolsStarRoundedFull(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
...
export function MaterialSymbolsStarOutlineRoundedHalf(
  props: SVGProps<SVGSVGElement>
) {
  return (
    <svg
